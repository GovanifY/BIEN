    ...
    public abstract class ImageContainer : IDisposable
    {
        ...
        protected static void requestQuantize(ref Bitmap input, System.Drawing.Imaging.PixelFormat target)
        {
            ...
            if (quant == null)
            {
                ...
                if (System.Windows.Forms.MessageBox.Show(string.Format("Input image has more colors then target type allows. Quantization can be attempted, which will reduce the number of colors used. This WILL reduce the quality of the image!\r\nIt's recommended that you do this yourself in your prefered image editor; you will have more control and get better results.\r\n\r\nInput Image: {0} ({2} colors)\r\nTarget image: {1} ({3} colors max)", input.PixelFormat, target, totalColor, MaxColor), "Image requires quantization", System.Windows.Forms.MessageBoxButtons.OKCancel, System.Windows.Forms.MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Cancel)
                {
